        ...
        <nav className="absolute top-0 left-0 right-0 z-20 w-full px-3 sm:px-6 lg:px-8 py-3 sm:py-4 backdrop-blur-sm">
          <div className="flex items-center justify-start gap-3 sm:gap-4">
            ...
            <Button
              ...
              className="text-left text-primary-foreground text-sm sm:text-base font-semibold backdrop-blur-sm rounded-full px-3 sm:px-4 py-2 hover:bg-white/10 transition-colors"
            >
                    ...
                    <Card className="overflow-hidden gap-0 cursor-pointer border-0 group bg-card shadow-md hover:shadow-xl transition-all duration-300 py-0 rounded-2xl">
                      ...
                      <div className="relative h-48 sm:h-56 md:h-60 w-full overflow-hidden rounded-t-2xl">
                        ...
                        <div className="absolute top-3 left-3">
                          <div className="bg-black/80 backdrop-blur-sm text-white px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium">
