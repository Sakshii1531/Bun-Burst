    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-black px-4 flex flex-col gap-2 border-b rounded-b-xl border-white">
        ...
        <div className="bg-white rounded-lg shadow-sm mb-4">
          ...
          {/* Salary Info (for fixed salary employees) */}
          {earningsData.salary?.type === 'fixed' && (
            <div className="px-4 py-3 bg-blue-50 border-b border-blue-100 mb-2">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Monthly Fixed Salary</p>
                  <p className="text-2xl font-bold text-blue-700">
                    ₹{earningsData.salary.amount.toLocaleString()}
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-blue-500">Joined</p>
                  <p className="text-sm font-medium text-blue-700">
                    {earningsData.joiningDate ? new Date(earningsData.joiningDate).toLocaleDateString('en-US', { month: 'short', year: 'numeric' }) : 'N/A'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="px-4 pb-4 text-center">
            ...
            {earningsData.salary?.type === 'fixed' && (
              <p className="text-xs text-gray-500 mt-1 font-medium">(Tips, Bonus & Incentives Only)</p>
            )}
          </div>
